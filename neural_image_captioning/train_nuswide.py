...
from data_manager_nuswide import DataManager
...
model_names = ('../trained_models/nuswide/' +
...
evaluator = Evaluator(model, data_path=preprocessed_data_path,
                      images_path=images_path,image_name_to_features_filename=object_image_features_filename)
