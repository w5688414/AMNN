...
class Evaluator(object):
    ...
    def display_caption(self, image_file=None, data_name=None):
        ...
        image_features = np.zeros((1, 7,7,512 ))
        image_features = features
        # print(self.BOS)
        num=0
        list_word_id=[]
        predictions = self.model.predict([tweet_vec,image_features])
        print(predictions)
...
if __name__ == '__main__':
    ...
    model_filename = './trained_model/co_attention/hashtag_weights.41-7.3178.hdf5'
