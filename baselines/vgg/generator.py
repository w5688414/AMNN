...
class Generator():
    ...
    def make_empty_batch(self):
        ...
        images_batch = np.zeros((self.BATCH_SIZE, self.IMG_FEATS*2))
    ...
    def get_image_features(self, image_name):
        ...
        image_input= np.concatenate((image_features,image_features_scene))
       
        # print(image_input)
        # print(image_features_scene)
        # print(np.array(image_input))
        return image_input
