...
class DataManager(object):
    ...
    def construct_dictionaries(self):
        ...
        self.word_to_id={word:word_id for word_id, word
                                in enumerate(words, 0)}
    ...
    def get_image_features(self, image_directory):
        ...
        if self.cnn_extractor == 'vgg16':
            ...
            from VGG16_places import VGG16_places
            from keras.applications.vgg16 import preprocess_input
            self.IMG_FEATS = 4096
            base_model = VGG16_places()
            base_model.load_weights("vgg_tensorflow_channels_last.h5")
